<!-- हिंदी संस्करण — v0.79 के साथ निर्मित, अपडेट के बाद पुराना हो सकता है -->
...
| `--engine c` | स्वचालित-निर्मित C कोर: ~89–113s में Linux-कर्नेल का पूरा ग्राफ़ (C इंजन) |
| `--verify FILE` | SHA-256 चेकसम सत्यापन |

**50 tree-sitter भाषाएँ डिस्पैच · 46 फ़िक्सचर-प्रोवन** (गोल्डन-फ़ाइल पैरिटी टेस्ट हर ग्रामर पर CI को गेट करते हैं) · **regex फ़ॉलबैक से 130+ एक्सटेंशन**।

## MCP सर्वर (82 टूल + 1 राउटर)
...
| सेटअप→उत्तर | **0.13s वार्म** | 41s pip + 4s बिल्ड + डेमन | इंडेक्सिंग के बाद | इंडेक्सिंग के बाद |

मापे गए आँकड़े: crg के मुकाबले सिंबल रिट्राईवल में **24–36× कम टोकन**; कॉम्पैक्शन रिकवरी **95.4% कम टोकन**; Linux कर्नेल का पूरा ग्राफ़ ~89–113s (C इंजन)। विवरण और रिप्रोडक्शन कमांड [`benchmarks/README.md`](benchmarks/README.md) में।
...
- **CI**: Linux/macOS/Windows × Python 3.8–3.12, 77 टेस्ट, गोल्डन फ़ाइलों से गेट किए गए ≥46 ग्रामर फ़िक्सचर
