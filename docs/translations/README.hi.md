...
मापे गए आँकड़े: crg के मुकाबले सिंबल रिट्राईवल में **43–54× कम टोकन**; कॉम्पैक्शन रिकवरी **95.4% कम टोकन**; Linux कर्नेल का पूरा ग्राफ़ ~89–113s (C इंजन)। विवरण और रिप्रोडक्शन कमांड [`benchmarks/README.md`](benchmarks/README.md) में।

**डॉगफ़ूड ईमानदार तुलना (2026-08-23, pallets/flask, same-session)**: हमने codeloom की तुलना एक छोटे रेपो पर सादे grep+read एजेंट से भी की — और नतीजा ईमानदारी से मिला-जुला है। छोटे रेपो पर टर्मिनल-पेलोड गिनती के साथ, codeloom ने सादे grep+read एजेंट से **ज़्यादा कुल टोकन (+14.5%) और ज़्यादा वॉल टाइम (+2.6×)** लिया; उसकी जीत एविडेंस पर रही — `--impact` ने ब्लास्ट रेडियस दिया (0.23 सेकंड में 5 डायरेक्ट + 33 ट्रांज़िटिव), `--task` ने ठीक वही 4 मॉड्यूल रैंक किए, और `--checkpoint`/`--checkpoint-restore` ने एडिट diff का हूबहू रिप्रोडक्शन किया। ऊपर के टोकन-एफ़िशिएंसी दावे (98.8%, 43–54×) **बड़े रेपो और grep+read बेसलाइन के मुकाबले कॉल-चेन** के लिए हैं — वही स्कोप उन्हें मापा गया था, छोटे सिंगल-शॉट कार्यों के लिए नहीं।
...
- **डॉगफ़ूड ईमानदारी (2026-08-23, pallets/flask)**: छोटे रेपो में टर्मिनल-पेलोड गिनती के साथ, codeloom ने सादे grep+read एजेंट से **ज़्यादा** कुल टोकन (+14.5%) और वॉल टाइम (+2.6×) इस्तेमाल किए; जीता सिर्फ़ सबूत पर (ब्लास्ट-रेडियस, मेमोरी/चेकपॉइंट बचाव)। दक्षता के दावे (98.8%, 43–54×) बड़े रेपो की चेन-ऑफ़-कॉल्स vs grep+read बेसलाइन पर लागू होते हैं ([`benchmarks/dogfood_bench.py`](benchmarks/dogfood_bench.py))।
...
- **CI**: Linux/macOS/Windows × Python 3.8–3.12, 111 टेस्ट, गोल्डन फ़ाइलों से गेट किए गए ≥46 ग्रामर फ़िक्सचर
