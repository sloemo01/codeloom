...
मापे गए आँकड़े: crg के मुकाबले सिंबल रिट्राईवल में **24–36× कम टोकन**; कॉम्पैक्शन रिकवरी **97.9% कम टोकन**; Linux कर्नेल का पूरा ग्राफ़ ~89–113s (C इंजन)। विवरण और रिप्रोडक्शन कमांड [`benchmarks/README.md`](benchmarks/README.md) में।
